...
def main():
    parser = argparse.ArgumentParser(
        description="Check and download updated Kaggle dataset."
    )
    parser.add_argument(
        "--dataset_download",
        type=yes_or_no,
        required=True,
        help="Do you have an API key set up?",
    )
    parser.add_argument(
        "--data_location",
        type=str,
    ...
    dataset = (
        "olistbr/brazilian-ecommerce"  # Change this to your dataset path on Kaggle
    )
